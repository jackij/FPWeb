...
SITE_CSS_URL = SITE_BASE + '/static/site.css'
...
def urls(app):
  ...
  app.add_url_rule(SITE_BASE + '/', 'index', (envey(PAGE=home_page)(lo)))
  ...
  app.add_url_rule(SITE_BASE + '/datapost', 'datapost', post_loader)

  app.add_url_rule(SITE_BASE + '/dash', 'dash', envey(PAGE=main_page)(dash))

  app.add_url_rule(SITE_BASE + '/study/<studyID>', 'study', envey(PAGE=study_page)(study))

  pro = envey(PAGE=profile_page)(profile)
  pro.methods = ['GET', 'POST']
  app.add_url_rule(SITE_BASE + '/profile', 'profile', pro)


def logins(app):
  logy = envey(PAGE=login_page)(login)
  logy.methods = ['GET', 'POST']
  app.add_url_rule(SITE_BASE + '/login', 'login', logy)

  logy = envey(PAGE=logout_page)(logout)
  logy.methods = ['GET', 'POST']
  app.add_url_rule(SITE_BASE + '/logout', 'logout', logy)
